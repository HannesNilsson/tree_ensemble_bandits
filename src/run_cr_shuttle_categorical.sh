...
n_jobs=7
n_processes=1
config="configs.config_shuttle_categorical"
res_path="../results/results_shuttle_categorical"
res_prefix="shuttle_categorical"
logging_level="info"
start_seed=0
...
nn_epsilon=0.05
linucb_alpha=0.1
xgb_exploration_factor=0.01
xgb_exploration_variance=0.01
xgb_max_depth=1000
